...
ERROR_DOME_MOVETIMEOUT = 'MOVING_TIMEOUT'
...
ERROR_MNT_PARKED = 'PARKED'
ERROR_MNT_NOTPARKED = 'NOT_PARKED'
ERROR_MNT_INBLINKY = 'IN_BLINKY'
ERROR_MNT_CONNECTION = 'LOST_CONNECTION'
ERROR_CAM_WARM = 'NOT_COOL'
ERROR_FILT_UNHOMED = 'NOT_HOMED'
