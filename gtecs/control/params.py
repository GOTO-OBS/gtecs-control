...
CRITICAL_MAX_HUMIDITY = config['CRITICAL_MAX_HUMIDITY']
MAX_INTERNAL_HUMIDITY = config['MAX_INTERNAL_HUMIDITY']
ALERT_INTERNAL_HUMIDITY = config['ALERT_INTERNAL_HUMIDITY']
...
ALERT_INTERNAL_TEMPERATURE = config['ALERT_INTERNAL_TEMPERATURE']
...
# Sky Temperature - measured in Celsius
MAX_SKYTEMP = config['MAX_SKYTEMP']
SKYTEMP_BADDELAY = config['SKYTEMP_BADDELAY']
SKYTEMP_GOODDELAY = config['SKYTEMP_GOODDELAY']
...
DOME_HAS_AIRCON = config['DOME_HAS_AIRCON']
AIRCON_URI = config['AIRCON_URI']
